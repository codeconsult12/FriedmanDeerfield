    ...
    actions
    {
        addafter(ReverseTransaction)
        {
            action("Move & Reverse Test")
            {
                ...
                Caption = 'Monthly Intercompany Test';
...
report 50110 "Move Reverse Entries"
{
    Caption = '';
    ProcessingOnly = true;
                ...
                if GLEnt.FindSet() then
                    repeat
                        ...
                        if DimComp = 'POSEIDON' THEN begin
                            //  Message('%1,%2,%3,%4,%5', DimProject, DimDept, DimComp, DimVend, DateValEnd);
                            CheckAndCreateBatch('zzz_Poseidon_01082021', generalBatch);
                            Create2Journals('zzz_Poseidon_01082021', GLEnt, DimProject, DimDept, DimComp, DimVend, DateValEnd);
                        end;
    ...
    var
        ...
        CompValID: Integer;
        VendValID: Integer;
        companywiseproject: Record CompanywiseProjectDetail;
        concat: Text;
        day: Integer;
        month: Integer;
        year: Integer;
    ...
    begin
        ...
        companywiseproject.SetFilter(companywiseproject.CompanyName, '=%1', CompanyName);
        //companywiseproject.SetFilter(companywiseproject.ProjectName, '=%1', Project);
        //Message('%1,%2', CompanyName, Project);
        ismatched := '';
        if companywiseproject.FindSet()
        then
            repeat

                if companywiseproject.ProjectName = Project then begin
                    GenJnlLine."Account No." := companywiseproject."Account No.";
                    Message('MAtched');
                end;


            until (companywiseproject.Next() = 0);
...
// codeunit 50111 CreateEditDimEntry
// {
