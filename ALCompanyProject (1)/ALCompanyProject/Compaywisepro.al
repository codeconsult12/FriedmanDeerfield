            ...
            begin
                ...
                if GLEnt.FindSet() then
                    repeat
                        ...
                        companywiseproject.SetFilter(CompanyCode, '%1', DimComp);
                        if companywiseproject.FindFirst() then begin
                            CheckAndCreateBatch(companywiseproject.CompanyName, generalBatch);
                            Create2Journals(companywiseproject.CompanyName, GLEnt, DimProject, DimDept, DimComp, DimVend, DateValEnd);
                        end;
